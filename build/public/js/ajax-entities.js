( function( $ ) {
    ...
    $( function() {
        ...
        $( document ).on( 'change', '.js-es-currencies', function() {
            var $el = $( this );
            var data = {
                currency: $el.val(),
                action: 'es_set_currency',
                _ajax_nonce: Estatik.nonce.set_currency,
            };

            $.post( Estatik.settings.ajaxurl, data, function() {
                $( '.js-es-sort' ).trigger( 'change' );
            } );
        } );
