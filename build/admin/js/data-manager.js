( function( $ ) {
    ...
    $( function() {
        ...
        $( document ).on( 'change', '.js-es-currency', function() {
            var code = $( this ).val();

            $( this ).closest( '.js-es-currency-row' ).find( '.js-es-sign' ).val( code ).trigger( 'change' );
        } );

        $( document ).on( 'change', '.js-es-sign', function() {
            var sign = $( this ).find( 'option:selected' ).text();
            var $row = $( this ).closest( '.js-es-currency-row' );
            sign = $( this ).val() ? sign : $row.find( '.js-es-currency option:selected' ).attr( 'value' );

            $row.find( '.js-es-append-sign option' ).each( function () {
                var $option = $( this );
