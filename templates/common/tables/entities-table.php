                                                ...
                                                <ul>
                                                    ...
                                                    <?php if ( current_user_can( 'edit_post', get_the_ID() ) ) : ?>
                                                        <li><a href="<?php echo add_query_arg( array(
                                                                'screen' => 'edit-' . $instance::get_entity_type(),
                                                                $instance::get_entity_type() . '_id' => get_the_ID(),
                                                            ) ); ?>"><?php _e( 'Edit', 'es' ); ?></a></li>
                                                    <?php endif; ?>
                                                    
                                                    <?php if ( current_user_can( 'edit_post', get_the_ID() ) && current_user_can( 'publish_es_properties' ) && $instance::get_entity_type() == "property") : ?>
                                                        <?php if ( get_post_status( get_the_ID() ) == 'publish' ) : ?>
                                                    ...
                                                    <?php if ( current_user_can( 'edit_post', get_the_ID() ) && current_user_can( 'publish_agencies' ) && $instance::get_entity_type() == "agency") : ?>
                                                        <?php if ( get_post_status( get_the_ID() ) == 'publish' ) : ?>
                                                            <li><a href="<?php echo es_get_action_post_link( get_the_ID(), 'draft' ); ?>"><?php _e( 'Unpublish', 'es' ); ?></a></li>
                                                        <?php else : ?>
                                                            <?php if ( es_user_can_publish_agencies() ) : ?>
                                                                <li><a href="<?php echo es_get_action_post_link( get_the_ID(), 'publish' ); ?>"><?php _e( 'Publish', 'es' ); ?></a></li>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
