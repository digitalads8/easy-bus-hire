...
<div class="es-settings-fields es-settings-fields--max-width">
    ...
    <?php es_settings_field_render( 'is_automatic_approval_of_agents_publication', array(
        'label' => __( 'Enable automatic publication of agents after registration', 'es' ),
        'type' => 'switcher',
        'attributes' => array(
            'data-toggle-container' => '#es-agents-automatic-publication-container',
        ),
    ) ); ?>
