...
<div class="es-settings-fields es-settings-fields--general es-settings-fields--max-width">
    ...
    <?php
    es_settings_field_render( 'is_additional_currencies_enabled', array(
        'label' => __( 'Enable Additional Currencies', 'es' ),
        'type' => 'switcher',
        'attributes' => array(
            'data-toggle-container' => '.es-field__is_additional_currencies_enabled .es-field__description',
        ),
        'description' => sprintf( __( 'Configure your additional currencies <a href="%s" target="_blank">here</a>.', 'es' ), esc_url( admin_url( 'admin.php?page=es_data_manager#es-currencies' ) ) )
    ) );
