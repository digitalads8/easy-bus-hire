...
<form method="post" class="js-es-plan-form">
    ...
    <?php if ( ests('is_subscriptions_enabled_agencies') ) : ?>
        <div class="es-fields-wrap">
            <?php es_plan_field_render( 'is_agencies_limited', array(
                'before' => '<div>',
                ...
                'attributes' => array(
                    'class' => 'js-es-is-limited',
                    'data-field' => '.es-field__basic_agencies_limit',
                ),
            ) );

            es_plan_field_render( 'agencies_limit', array(
                'label' => __( 'Number of agencies', 'es' ),
                'type' => 'number',
                'attributes' => array(
                    'min' => 0,
                    'required' => 'required',
