...
<ul class="js-es-control es-control es-control--<?php echo $context; ?>">
	<?php if ( $compare->is_enabled() && ! empty( $show_compare ) && es_get_entity_by_id( $entity_id ) ) :
	...
	<?php endif; ?>
	<?php if ( ests( 'is_' . $entity_plural . '_wishlist_enabled' ) && $show_wishlist && es_get_entity_by_id( $entity_id ) ) :
