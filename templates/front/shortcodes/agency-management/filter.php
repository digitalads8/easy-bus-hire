...
<div class="es-sort-wrap">
    <form action="<?php echo es_get_current_url(); ?>" method="get" class="es-agency-sort-form js-es-submit-on-form-change">
    ...
    <?php if ( ests( 'is_frontend_management_enabled' ) && ! empty( $config['show_add_new'] ) && ( $url = es_get_add_new_agency_url() ) ) : ?>
