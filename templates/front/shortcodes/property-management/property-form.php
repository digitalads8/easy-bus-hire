    ...
    <div class="es-property-management es-property-management--form content-font" id="es-property-management-form">
        ...
        <form action="" method="POST" class="es-property-form js-es-ajax-form" enctype="multipart/form-data">
            ...
            es_framework_view_render( 'tabs', array(
                ...
                'show_logo' => false,
                'before_content_tabs' => "<h3 class='heading-font es-tabs__title'>" . __( 'Add new property', 'es' ) . "</h3>",
                'after_content_tabs' => $manage_buttons
            ) ); ?>

            <?php if ( isset( $_GET['property_translation_id'] ) && ! empty( $_GET['property_lang'] ) ) : ?>
                <input type="hidden" name="property_lang_original_id" value="<?php esc_attr_e( es_get( 'property_translation_id' ) ); ?>"/>
                <input type="hidden" name="property_lang" value="<?php esc_attr_e( es_get( 'property_lang' ) ); ?>"/>
            <?php endif; ?>
