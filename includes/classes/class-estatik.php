...
class Estatik {
	...
	protected function load_files() {
		...
		$files = apply_filters( 'es_plugin_files', array(
			...
			'es_order-meta-box' => ES_PLUGIN_CLASSES . 'meta-boxes' . DS . 'class-order-fields-meta-box.php',
			...
			'agencies-table' => ES_PLUGIN_CLASSES . 'entities' . DS . 'tables' . DS . 'class-agencies-table.php',
