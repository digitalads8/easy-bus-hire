		...
		return array(
			...
			'4.1.7' => array(
				...
				'changes' => array(
					...
					array(
						'text' => _x( 'Duplicated records for repeater estatik fields fix added" (All versions)', 'changelog', 'es' ),
						'label' => 'bugfix',
					),
					array(
    ...
    public static function get_links() {
        return apply_filters( 'es_dashboard_get_links', array(
            ...
            'agencies' => array(
                ...
                'icon' => '<span class="es-icon es-icon_agency es-icon--rounded es-icon--green"></span>',
