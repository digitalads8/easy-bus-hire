 ...
 * @property integer $is_subscriptions_enabled_agencies
	...
	public static function get_available_settings( $force = false ) {
		...
		if ( ! static::$settings_list || $force ) {
			static::$settings_list = array(
				...
				'service_area_slug' => array(
					'default_value' => 'service-area',
				),
...
//						'single-full-width-tiled' => __( 'With full-width tiled gallery', 'es' ),
				...
				'is_subscriptions_enabled_agencies' => array(
					'default_value' => 0,
				),
				...
				'is_additional_currencies_enabled' => array(
					'default_value' => 0,
				),
				...
				'is_automatic_approval_of_agents_publication' => array(
					'default_value' => 1,
				),
				...
				'is_agent_collapsed_description_enabled' => array(
					'default_value' => 1,
				),

				'is_agency_collapsed_description_enabled' => array(
					'default_value' => 1,
				),
...
',
				...
				'saved_search_email_subject' => array( 
					'default_value' => 'New listings matching your saved search', 
				),
